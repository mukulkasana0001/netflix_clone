...
const signIn2 = document.getElementById('signIn');
const section2 = document.getElementById('section2');

section2.addEventListener('change', function () {
  if (section2.value === 'en-IN') {
    signIn2.textContent = 'signIn';
  ...
  else if (section2.value === 'hi-IN') {
    signIn2.textContent = 'साइन इन करें';
